...
<head>
    <meta charset="utf-8">
    <title>Mazao - Mkulima Janja</title>
...
<body>
    ...
    <div class="container-fluid page-header mb-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container">
            <h1 class="display-3 mb-3 animated slideInDown">Mazao</h1>
            <nav aria-label="breadcrumb animated slideInDown">
                <ol class="breadcrumb mb-0">
                    <li class="breadcrumb-item"><a class="text-body" href="#">Home</a></li>
                    <li class="breadcrumb-item text-dark active" aria-current="page">Mazao</li>
                </ol>
            </nav>
        </div>
    </div>
                ...
                <div id="tab-1" class="tab-pane fade show p-0 active">
                    <div class="row g-4">
                        ...
                        <div class="col-12 text-center wow fadeInUp" data-wow-delay="0.1s">
                            <a class="btn btn-primary rounded-pill py-3 px-5" href="">Tazama Mbolea Zingine</a>
                        </div>
                    </div>
                </div>
            </div>
